        ...
        <div class="listItems max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
            ...
            <div class="p-5">
                ...
                <div class="flex gap-2 justify-center">
                    ...
                    <!-- Modal toggle -->
                    <button data-modal-target="<?php echo $cruise->ID_croisere;?>" data-modal-toggle="<?php echo $cruise->ID_croisere;?>" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                        Edit
                    ...
                    <div id="<?php echo $cruise->ID_croisere;?>" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                        <div class="relative w-full h-full max-w-md md:h-auto">
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-hide="<?php echo $cruise->ID_croisere ;?>">
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    <h3 class="mb-4 text-xl font-medium text-gray-900">Update cruise</h3>
                                    <form class="space-y-6" method="POST" action="<?php echo URLROOT . 'Managers/updateCruise/' . $cruise->ID_croisere;?>"  enctype="multipart/form-data">
                                        ...
                                        <div>
                                            <label for="Cruise_name" class="block mb-2 text-sm font-medium text-gray-900 ">Price</label>
                                            <input type="float" name="price" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 " value="<?php echo $cruise->distination;?>">
                                        </div>
                                        <button type="submit" class="w-full text-white bg-[#245BA8] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Update cruise</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <button data-modal-target="<?php echo $cruise->ID_croisere . "delete";?>" data-modal-toggle="<?php echo $cruise->ID_croisere . "delete";?>" class="block text-white bg-red-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                        delete
                    </button>
                    ...
                    <div id="<?php echo $cruise->ID_croisere . "delete";?>" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                        <div class="relative w-full h-full max-w-md md:h-auto">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-hide="<?php echo $cruise->ID_croisere . "delete";?>">
                                    <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span class="sr-only">Close modal</span>
