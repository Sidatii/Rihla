                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-6" method="POST" action="<?php echo URLROOT . 'Managers/updateCruise/' . $cruise->ID_croisere;?>"  enctype="multipart/form-data">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="depPort" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500" value="<?php echo $cruise->departure_port_ID;?>">
                                        </div>
                                        <div>
