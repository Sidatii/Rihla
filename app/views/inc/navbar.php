            ...
            <?php if (isset($_SESSION['user_id'])) : ?>
                ...
                <div id="userDropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                    ...
                    <ul class="py-1 text-sm text-gray-700" aria-labelledby="avatarButton">
                            ...
                            <li>
                                <a href="<?php echo URLROOT . 'pages/dashboard'; ?>" class="<?php echo isAdmin();?> py-2 px-4 hover:bg-gray-100 ">Dashboard</a>
                            </li>
                        <?php else :?>
                            <li>
                            <a href="#" class="<?php echo isUser();?> py-2 px-4 hover:bg-gray-100 ">My bookings</a>
                        </li>
                        <?php endif;?>
                        <li>
