    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="flex md:order-2 gap-2">
            <div class="<?=$_SESSION['isLoggedin']; ?>">
                <img id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="w-10 h-10 rounded-full cursor-pointer shadow-md" src="<?php echo URLROOT . 'public/img/user.svg'; ?>" alt="User dropdown">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            <ul class="flex flex-col p-4 mt-4 border rounded-lg bg-[#F1F1F1] md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-[#F1F1F1] md:dark:bg-[#F1F1F1] dark:border-[#245BA8]">
                ...
                <li>
                    ...
                    <a href="<?php echo URLROOT . 'Managers/ships'; ?>" class="<?php echo $_SESSION['is_admin'];?> block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:font-semibold md:p-0 dark:text-gray-400 dark:hover:bg-[#245BA8] sm:dark:hover:text-white  md:dark:hover:text-[#245BA8] md:dark:hover:bg-transparent dark:border-gray-700 sm:text-[#245BA8] font-medium font-alternate subpixel-antialiased">Ships</a>
                </li>
                <li>
